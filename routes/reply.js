"use strict";
var replyDBModel = require('../models/reply.js');
...
var topics =new replyDBModel.Schema("Reply").model;
    ...
    for (var j = 0; j < replies.length; j++) {
      (function (i) {
        ...
        User.getUserById(author_id, function (err, author) {
          ...
          tools.linkUsers(replies[i].content, function (err, str) {
            if (err) {
              return cb(err);
            }
